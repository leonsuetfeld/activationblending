...
if __name__ == '__main__':
	...
	parser.add_argument('-safe_af_ws_n', type=int, nargs='*', help='number of times the af weights are saved during the run')
	parser.add_argument('-safe_all_ws_n', type=int, nargs='*', help='number of times all weights are saved during the run')
