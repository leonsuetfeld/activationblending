...
if __name__ == '__main__':
	...
	parser.add_argument('-dropout_keep_probs', metavar='DROPOUT_KEEP_PROBS', default=None, type=float, nargs=1, help='keep_probs for dropout.')
	parser.add_argument('-lr', metavar='LEARNING_RATE', default=None, type=float, nargs=1, help='learning rate.')
	parser.add_argument('-lr_step_ep', metavar='LR_STEP_EP', default=None, type=float, nargs=1, help='epochs with steps in learning rate scheduler.')
	parser.add_argument('-use_wd', metavar='USE_WD', default=None, type=float, nargs=1, help='boolean, enables weight decay if true.')
	parser.add_argument('-wd_lambda', metavar='WD_LAMBDA', default=None, type=float, nargs=1, help='lambda for weight decay.')
	parser.add_argument('-lr_step_multi', metavar='LR_STEP_MULTI', default=None, type=float, nargs=1, help='multiplicative factors applied to lr after corresponding epoch was reached.')
