...
if int(TASK_ID) < 11:
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_relu' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
...
########################################################### 31-40 SOFTPLUS #####
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_softplus' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
...
########################################################### 41-50 SOFTSIGN #####
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_softsign' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
...
############################################################ 61-70 SIGMOID #####
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_sigmoid' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
...
############################################################ 71-80 SWISH_1 #####
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_swish_1' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
...
############################################################ 81-90 SWISH_A #####
	...
	command = "python3 "          		+ 'deepnet_main.py' + \
			  " -experiment_name="  	+ 'SBF_1b' + \
			  " -spec_name="        	+ 'fixed_scaled_swish_adaptive' + \
			  " -run="              	+ str(RUN) + \
			  " -task="             	+ 'cifar10' + \
			  " -network="          	+ 'smcn' + \
			  " -mode="             	+ 'training' + \
