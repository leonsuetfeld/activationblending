...
def get_settings():
	...
	experiment_name = 'm_ASC_main'                                                # change when swapping between deployed and development folders
	spec_list = ['smcn_sgdm_c10_I',
				 'smcn_sgdm_c10_alpha_I',
				 'smcn_sgdm_c10_relu',
				 'smcn_sgdm_c10_alpha_relu',
				 'smcn_sgdm_c10_tanh',
				 'smcn_sgdm_c10_alpha_tanh',
				 'smcn_sgdm_c10_elu',
				 'smcn_sgdm_c10_alpha_elu',
				 'smcn_sgdm_c10_selu',
				 'smcn_sgdm_c10_alpha_selu',
				 'smcn_sgdm_c10_swish',
				 'smcn_sgdm_c10_alpha_swish',
				 'smcn_sgdm_c10_ABU_TERIS',
				 'smcn_sgdm_c10_ABU_S_TERIS',
				 'smcn_sgdm_c10_ABU_N_TERIS',
				 'smcn_sgdm_c10_ABU_A_TERIS',
				 'smcn_sgdm_c10_ABU_P_TERIS']
	n_runs = 30
	gridjob_command = 'qsub 2_scheduling/m_advanced_scheduler_gridjob.sh'
