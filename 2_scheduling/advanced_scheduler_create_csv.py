...
if __name__ == '__main__':
    ...
    asc.csv_update(scheduling_subfolder, experiment_name+'.csv', experiment_path, experiment_name, mark_running_as_incomplete=True) # set this to False when executing during gridjob
