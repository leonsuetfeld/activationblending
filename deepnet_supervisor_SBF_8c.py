...
if TASK_ID < 41:
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'adaptive_linu_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
...
################################################################################
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'adaptive_relu_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
			  " -preprocessing="				+ 'ztrans' +\
			  " -network="          			+ 'smcn' + \
...
################################################################################
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'adaptive_elu_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
			  " -preprocessing="				+ 'ztrans' +\
			  " -network="          			+ 'smcn' + \
...
################################################################################
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'blend5_unrest_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
			  " -preprocessing="				+ 'ztrans' +\
			  " -network="          			+ 'smcn' + \
...
################################################################################
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'blend5_normalized_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
			  " -preprocessing="				+ 'ztrans' +\
			  " -network="          			+ 'smcn' + \
...
################################################################################
	...
	command = "python3 "          				+ 'deepnet_main.py' + \
			  " -experiment_name "  			+ 'SBF_8c' + \
			  " -spec_name "        			+ 'blend5_posnormed_pretrained_adaptive' + \
			  " -run "              			+ str(RUN) + \
			  " -task="             			+ 'cifar10' + \
			  " -preprocessing="				+ 'ztrans' +\
			  " -network="          			+ 'smcn' + \
