...
def get_settings():
	...
	experiment_name = 't_ASC_main'                                                # change when swapping between deployed and development folders
	...
	n_runs = 5
	gridjob_command = 'qsub 2_scheduling/t_advanced_scheduler_gridjob.sh'
