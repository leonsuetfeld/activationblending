...
def get_settings():
	...
	experiment_name = 'd_ASC_main'                                                # change when swapping between deployed and development folders
	spec_list = ['smcnd_adam_c10_I',
				 'smcnd_adam_c10_alpha_I',
				 'smcnd_adam_c10_relu',
				 'smcnd_adam_c10_alpha_relu',
				 'smcnd_adam_c10_tanh',
				 'smcnd_adam_c10_alpha_tanh',
				 'smcnd_adam_c10_elu',
				 'smcnd_adam_c10_alpha_elu',
				 'smcnd_adam_c10_selu',
				 'smcnd_adam_c10_alpha_selu',
				 'smcnd_adam_c10_swish',
				 'smcnd_adam_c10_alpha_swish',
				 'smcnd_adam_c10_ABU_TERIS',
				 'smcnd_adam_c10_ABU_S_TERIS',
				 'smcnd_adam_c10_ABU_N_TERIS',
				 'smcnd_adam_c10_ABU_A_TERIS',
				 'smcnd_adam_c10_ABU_P_TERIS']
	n_runs = 30
	gridjob_command = 'qsub 2_scheduling/d_advanced_scheduler_gridjob.sh'
